	...
	public static void main(String[] args) {
		...
		while (!end) {
			...
			try {
				...
				if (copy > 0) {
					System.out.println("You've Rented : " + books.get(choice).getName());
					book.setCopy(copy -= 1);
				} else {
				...
				System.out.println("Error! Input must be a number only");
			} catch (IndexOutOfBoundsException e) {
				System.out.println("Error: Input is not found in the choices");
			}
